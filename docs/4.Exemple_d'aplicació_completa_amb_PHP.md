...
Per a la resta de les pàgines creanrem una plantilla amb les parts comunes a totes les pàgines como són la capçalera i el footer.

Copiem el codi html de la capçalera i el peu a un fitxer que anomenaren **main.blade.php** i que ficarem dins d'una carpeta anomenada **layout** dins de **views**.
...
<body class="pagproductos">
    <div id="contenedor">
        ...
        <div id="pie">
            ...
            <a href="addProduct.php" class="boton" style='width:100%;' />Afegir Producte</a>
            <?php } ?>
            <form action='categories.php' method='post'>
                <!-- Botón del mismo tipo que los demás -->
                <input type='submit' name='categories' class='boton' style='width:100%;' value='Tornar Categories' ?>
...
Així crearem una carpeta **layouts** per ficar un fitxer **main.blade.php** on estarà la fussió entre header i footer. Estos dos fitxers els podrem esborrar perquè ja no els utilitzarem.
