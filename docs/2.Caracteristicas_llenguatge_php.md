...
* Crea una vista per a mostrar el resultat de la calculadora. Lleva el resultat de les variables globals i posa un encapçalament amb el operands.
* Descarrega la [plantilla](https://plantillashtmlgratis.com/wp-content/themes/helium-child/descargas/page265/scorilo.zip) gratuita i possa-la en el teu lloc de projecte per a que funcione (**carpeta projecte/public**) en l'adreça **projecte.dwes.my**
* Crea una carpeta views i anem a descomposar el fitxer index.html en diferents vistes 
