...
##### <a name="2.1.1>Controladors de recursos</a>
...
* Crea un [controlador](#2.1.1) de recursos (opció -r ) anomenat **PostController** , que ens servirà per a gestionar tota la lògica dels posts del blog.
