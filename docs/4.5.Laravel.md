...
aquestes insercions i modificacions. La primera pot apuntar a **/movies/nuevoPrueba** ,
per exemple, i la segona a **/movies/editarPrueba/{id}** . Recorda també eliminar o editar la
